...
var LoginController = (function (_super) {
    ...
    function LoginController() {
        var _this = _super.call(this, ModuleEnum.LOGIN) || this;
        Facebook.init();
        return _this;
    }
    ...
    LoginController.prototype.preShow = function (data) {
    };
    LoginController.prototype.show = function (data) {
        ...
        if (Utils.isRuntime) {
            BatterInfo.instance.init().then(function (data) {
                game.BattleManager.instance.init().then(function () {
    ...
    LoginController.prototype.loginWx = function () {
